...
<figure class="jax-fig jax-fig-wide">
  ...
  <figcaption>The width ladder. The trained arm's dashed curve enters at 86.3 with sixteen units, already above every frozen point anywhere in the sweep.</figcaption>
</figure>
