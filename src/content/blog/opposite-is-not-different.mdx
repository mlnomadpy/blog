...
description: The cosine-similarity scale has three landmarks, not two. Maximum difference is orthogonality, not opposition — and the most influential contrastive losses spent years optimizing for the wrong target.
pubDate: 2026-02-22
tags: [ml, geometry, contrastive, embeddings]
---
