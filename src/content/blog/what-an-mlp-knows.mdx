...
description: The MLP block is illegible because its primitive does not carry a kernel. Give it one and the four objects that make attention legible — pairwise scores, normalised contributions, named geometry, prototype units — follow for free.
pubDate: 2026-05-21
tags: [ml, interpretability, kernels, mlp]
---
