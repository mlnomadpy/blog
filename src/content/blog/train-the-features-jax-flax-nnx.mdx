...
<figure class="jax-fig">
  <img src="/blog/train-head-swap.png" alt="A bar chart on one frozen trained backbone with three heads side by side: a random linear head at 16%, the built Yat head at 86%, and the trained linear head at 88%" loading="lazy" width="816" height="600" />
